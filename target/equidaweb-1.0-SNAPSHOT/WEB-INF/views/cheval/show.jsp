        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="form-container">
                <%
                    ...
                    if(leCheval != null) {
                %>
                <!-- L'en-tête avec le nom du cheval -->
                ...
                <!-- NOUVEAU : Affichage du SIRE -->
                <div class="row detail-row">
                    <div class="col-sm-3 detail-label">N° SIRE</div>
                    <div class="col-sm-9 detail-value">
                        <%= (leCheval.getSire() != null && !leCheval.getSire().isEmpty()) ? leCheval.getSire() : "Non renseigné" %>
                    </div>
                </div>

                <!-- NOUVEAU : Affichage du Sexe -->
                <div class="row detail-row">
                    <div class="col-sm-3 detail-label">Sexe</div>
                    <div class="col-sm-9 detail-value">
                        <%
                            if ("M".equals(leCheval.getSexe())) out.print("Mâle (M)");
                            else if ("F".equals(leCheval.getSexe())) out.print("Femelle (F)");
                            else if ("G".equals(leCheval.getSexe())) out.print("Hongre (G)");
                            else out.print("Non renseigné");
                        %>
                    </div>
                </div>
                ...
                <!-- Boutons Action (Retour & Modifier) -->
                <div class="row" style="margin-top: 30px;">
                    <div class="col-sm-12">
                        ...
                        <!-- NOUVEAU : Le bouton Modifier -->
                        <a href="<%= request.getContextPath() %>/cheval-servlet/update?idCheval=<%= leCheval.getId() %>" class="btn btn-warning pull-right">
